...
/**
 * Create default ChainTracker instance
 */
export function createDefaultChainTracker(): FallbackChainTracker {
  return new FallbackChainTracker(
    'https://arcade-us-1.bsvb.tech',
    'https://mainnet-chaintracks.babbage.systems'
  )
}
